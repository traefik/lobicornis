...
func TestRepository_getMergeMethod(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			defaultMergeMethod:  MergeMethodSquash,
			mergeMethodPrefix:   "",
			expectedMergeMethod: MergeMethodSquash,
		},
		{
		...
		},
		{
			...
			defaultMergeMethod:  MergeMethodSquash,
			mergeMethodPrefix:   "go-",
			expectedMergeMethod: MergeMethodRebase,
		},
		{
			...
			defaultMergeMethod:  MergeMethodSquash,
			mergeMethodPrefix:   "go-",
			expectedMergeMethod: MergeMethodFastForward,
		},
		{
